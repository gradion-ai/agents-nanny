...
!!! tip "freeact"
    ...
    An alternative implementation of this approach is the [freeact](https://gradion-ai.github.io/freeact/) code action agent.
...
!!! note "Setup"
    ...
    For environment setup, plugin installation, and a step-by-step walkthrough of the GitHub example in Claude Code, refer to the [plugin documentation](https://gradion-ai.github.io/ipybox/ccplugin/). The subsections below provide an overview of the core ideas.
...
```python title="search_repositories API augmentation"
...
```python title="commits_of_top_repos API"
